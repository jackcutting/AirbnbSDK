...
namespace AirbnbSDK\Response\Listing\Listing;

use AirbnbSDK\Response\Listing\Listing\Review\RecentReview;
...
class Listing
{
    ...
    /**
     * @JMS\Type("AirbnbSDK\Response\Listing\Listing\User")
     *
     * @var User $user
     */
    private $user;
    ...
    /**
     * @JMS\Type("array<AirbnbSDK\Response\Listing\Listing\User\User>")
     *
     * @var User{] $hosts
     */
    private $hosts;
    ...
    /**
     * @JMS\Type("AirbnbSDK\Response\Listing\Listing\User\User")
     *
    ...
    /**
     * @JMS\Type("AirbnbSDK\Response\Listing\Listing\GuestControls")
     *
    ...
    /**
     * @JMS\Type("array<AirbnbSDK\Response\Listing\Listing\Photo>")
     *
     * @var Photo[] $photos
     */
    private $photos;
    ...
    /**
     * @JMS\Type("AirbnbSDK\Response\Listing\Listing\Review\RecentReview")
     *
    ...
    /**
     * @JMS\Type("AirbnbSDK\Response\Listing\Listing\ListingOccupancyInfo")
     *
