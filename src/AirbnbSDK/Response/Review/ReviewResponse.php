...
use AirbnbSDK\Response\Review\Listing\Listing;
use AirbnbSDK\Response\Review\User\User;
...
class ReviewResponse implements ResponseInterface
{
    ...
    /**
     * @JMS\Type("AirbnbSDK\Response\Review\User\User")
     *
     * @var User $author
     */
    private $author;
    ...
    /**
     * @JMS\Type("AirbnbSDK\Response\Review\Listing\Listing")
     *
     * @var Listing $listing
     */
    private $listing;
